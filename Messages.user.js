...
(function () {
    ...
    let msglist = [
        ...
        "Уважаемые учащиеся, прошу перестать флудить. Не мешайте друг другу в учебе.",
        "Уважаемые учащиеся, пожалуйста, обновите страницу, и напишите о своей проблеме на: ask@foxford.ru.",
        "Всем спасибо за внимание. До новых встреч!",
        "Уважаемые учащиеся, мы уходим на технический перерыв. Не расходитесь, вебинар скоро продолжится."
    ]
