...
(function () {
    ...
    let msglist = [
        ...
        "первое предупреждение, дальше - бан.",
        "обновите страницу и проверьте своё интернет-соединение.",
        ...
        "ссылка на скачивание презентации будет доступна в материалах к занятию после окончания занятия.",
        "Дорогие учащиеся, прошу перестать флудить. Не мешайте друг другу в учебе.",
        "Дорогие учащиеся, пожалуйста, обновите страницу, и напишите о своей проблеме на: ask@foxford.ru.",
        "Друзья, занятие закончилось. До новых встреч!",
        "Друзья, мы уходим на технический перерыв. Не расходитесь, вебинар продолжится через несколько минут."
    ]
